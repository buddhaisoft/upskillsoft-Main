<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="upskillsoft.fullwidth.WebForm1" %>
...
<head>
	<title>UpSkillSoft Online Training</title>
                                ...
                                <div class="container">
                                    ...
                                    <div id="navbar-collapse-1" class="navbar-collapse collapse pull-right">
                                        ...
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="dropdown">
                                                <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-leaf"></i> Layouts</a>
                                            ...
                                            <li class="dropdown yamm-fw">
                                                <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-leaf"></i> Features</a>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <ul class="col-sm-6 col-md-3 list-unstyled ">
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        Latin words, combined with an handful of model an sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free.
                                                                    </li>
                                                                </ul>
                                            ...
                                            <li class="dropdown">
                                                <a href="#" data-toggle="dropdown" class="dropdown-toggle active"><i class="fa fa-pagelines"></i> Pages</a>
                                            ...
                                            <li class="dropdown">
                                                <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-file-image-o"></i> Portfolio</a>
                                                <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li class="dropdown">
                                                <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-comment"></i> Blog</a>
                                            ...
                                            <li class="dropdown">
                                                <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-phone"></i> Contact</a>
        ...
        <div class="copyright_info">
            <div class="container">
                ...
                <div class="one_half animate" data-anim-type="fadeInRight">
                    ...
                    Copyright © 2020 www.UpSkillSoft.. All rights reserved.  <a href="#">Terms of Use</a> | <a href="#">Privacy Policy</a>
